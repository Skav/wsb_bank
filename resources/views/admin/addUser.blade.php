...
@section('content')
    <div class="container py-5">
        <h2 class="text-center mb-4">Dodawanie Użytkownika</h2>
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                @endif
                <form class="needs-validation" novalidate method="post" action="/admin/addUser">
                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label">Imię</label>
                        <input type="text" id="name" name="name" class="form-control" placeholder="Wprowadź imie" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="surname" name="surname" class="form-control" placeholder="Wprowadź nazwisko" required>
                        <div class="invalid-feedback">To pole jest wymagane.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="age" name="age" class="form-control" placeholder="Wprowadź wiek" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="Wprowadź adres email" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" id="phone" name="phone" class="form-control" placeholder="Wprowadź numer telefonu" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio" id="gender-female" class="form-radio" placeholder="Kobieta" value="female" name="gender" checked>
